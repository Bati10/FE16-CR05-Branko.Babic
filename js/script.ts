...
class animal {
    ...
    constructor (img: string, name: string, age: number, gender: string, size: string, vaccine: boolean) {
        this.img = img;
        this.name = name;
        this.age = age;
        this.gender = gender;
...
class cat extends animal {
    ...
    pattern: string;
    web: string;
    constructor (img: string, name: string, age: number, gender: string, size: string, vaccine: boolean, breed: string, pattern: string, web: string){
...
class dog extends animal {
    breed: string;
    trSkills: string;
    constructor (img: string, name: string, age: number, gender: string, size: string, vaccine: boolean, breed: string, trSkills: string) {
        super(img, name, age, gender, size, vaccine);
        this.breed = breed;
...
(document.getElementById("sortIcon") as HTMLElement).addEventListener("click", sortbyAge);

function sortbyAge () {
  animals.sort(function(a, b) {
      return a.age - b.age});
       (document.getElementsByClassName("ruf")[0] as HTMLElement).innerHTML ="";
       printCard();
  }

function printCard() {
    for (let val of animals) {
    (document.getElementsByClassName("ruf")[0] as HTMLElement).innerHTML += val.displayCard()
};
};
printCard();
